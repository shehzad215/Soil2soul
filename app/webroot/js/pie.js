		...
		drawChart: function() {
			...
			if (k.ifArray(a)) {
				if (0 < this.realWidth && 0 < this.realHeight) {
					...
					l = f(this.radius, d, g);
					l || (d = 0 <= x ? d - h - e - 2 * q : d - h - e, g = g - z - n, l = Math.min(d, g), g < d && (l /= 1 - this.angle / 90, l > d && (l = d)), g = k.toCoordinate(this.pullOutRadius, l), l = (0 <= x ? l - 1.8 * (x + g) : l - 1.8 * g) / 2);
					l < this.minRadius && (l = this.minRadius);
					g = f(this.pullOutRadius, l);
					z = k.toCoordinate(this.startRadius, l);
					f = f(this.innerRadius, l);
					f >= l && (f = l - 1);
					...
					for (var E, h = 0; h < a.length; h++)
						if (e = a[h], !0 !== e.hidden && (this.showZeroSlices || 0 !== e.percents)) {
							var r = 360 * e.percents / 100,
								...
								C = d / l * -Math.cos((n + r / 2) / 180 * Math.PI),
								p = this.outlineColor;
							p || (p = e.color);
							var v = this.alpha;
							isNaN(e.alpha) || (v = e.alpha);
							p = {
								fill: e.color,
								stroke: p,
							...
							p = k.wedge(c, A, B, n, r, l, d, f, this.depth3D, p, this.gradientRatio, e.pattern, this.path, this.gradientType);
							k.setCN(this, p, "pie-item");
							k.setCN(this, p.wedge, "pie-slice");
							k.setCN(this, p, e.className, !0);
							this.addEventListeners(p,
								e);
							e.startAngle = n;
							a[h].wedge = p;
							...
							if (this.labelsEnabled && this.labelText && e.percents >= this.hideLabelsPercent) {
								...
								var r = A + q * (l + t),
									D = B + C * (l + t),
									w, u = 0;
								isNaN(E) && 350 < m && 1 < a.length - h && (E = h - 1 + Math.floor((a.length - h) / 2));
								if (0 <= t) {
									var y;
									90 >= m && 0 <= m ? (y = 0, w = "start", u = 8) : 90 <= m && 180 > m ? (y = 1,
										w = "start", u = 8) : 180 <= m && 270 > m ? (y = 2, w = "end", u = -8) : 270 <= m && 354 >= m ? (y = 3, w = "end", u = -8) : 354 <= m && (h > E ? (y = 0, w = "start", u = 8) : (y = 3, w = "end", u = -8));
									e.labelQuarter = y
								} else w = "middle";
								m = this.formatString(this.labelText, e);
								(t = this.labelFunction) && (m = t(e, m));
								t = e.labelColor;
								t || (t = this.color);
								"" !== m && (m = k.wrappedText(c, m, t, this.fontFamily, this.fontSize, w, !1, this.maxLabelWidth), k.setCN(this, m, "pie-label"), k.setCN(this, m, e.className, !0), m.translate(r + 1.5 * u, D), m.node.style.pointerEvents = "none", e.ty = D, e.textX = r + 1.5 * u, v.push(m), this.axesSet.push(v), e.labelSet = v, e.label = m);
								e.tx = r;
								e.tx2 = r + u;
								e.tx0 = A + q * l;
								e.ty0 = B + C * l
							...
							if (0 === e.alpha || 0 < b && !this.chartCreated) p.hide(), v && v.hide();

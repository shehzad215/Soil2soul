...
class OAuth2Client
{
	...
	public function authenticate( $code )
	{
		...
		$response = $this->request( $this->token_url, 'code='.$code.'&client_id='.$this->client_id.'&client_secret='.$this->client_secret.'&redirect_uri='.$this->redirect_uri.'&grant_type=authorization_code', $this->curl_authenticate_method );

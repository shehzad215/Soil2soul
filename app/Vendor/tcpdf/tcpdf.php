...
class TCPDF {
	...
	public function Footer() {
		...
		$this->SetTextColorArray($this->footer_text_color);
		 $this->writeHTMLCell(0, 10, '', '', '<span style="font-family: verdana, arial, sans-serif; font-size:10px;" ><b>B.K. Birla College of Arts, Science & Commerce, Kalyan</b></span>', '', 1, 0, true, 'L', true);
		...
		if (empty($this->pagegroups)) {
			$pagenumtxt = $w_page.'Page '.$this->getAliasNumPage().' of '.$this->getAliasNbPages();
		} else {
			$pagenumtxt = $w_page.'Page '.$this->getAliasNumPage().' of '.$this->getAliasNbPages();
		}
		$this->SetY($cur_y);
		...
		if ($this->getRTL()) {
			...
			$this->Cell(0, 10, $this->getAliasRightShift().$pagenumtxt, 'T', 0, 'R');
			 //$this->writeHTMLCell(0, 10, '', '', '<span style="font-family: verdana, arial, sans-serif; font-size:10px;" >'.$this->getAliasRightShift().$pagenumtxt.'</span>', '', 1, 0, true, 'R', true);
		}

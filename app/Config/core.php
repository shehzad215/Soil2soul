 ...
 */
	Configure::write('Security.salt', 'DYhG93b0qyJfIxfs2guVoU23asubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76859309657453542496741239683645');
...
/* Additional Custom Cache Config */
Cache::config('find_paginate_app_cache', array(
    'engine' => 'File',
    'path' => CACHE .'sql'. DS,
    'serialize' => true,
    'duration' => '+1 month',
	'groups' => array('organizations')
));

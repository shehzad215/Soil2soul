<?php
App::uses('EventsSupplier', 'Model');

/**
 * EventsSupplier Test Case
 *
 */
class EventsSupplierTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->EventsSupplier = ClassRegistry::init('EventsSupplier');
	}

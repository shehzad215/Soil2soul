<?php
App::uses('WebsiteStallDetail', 'Model');

/**
 * WebsiteStallDetail Test Case
 *
 */
class WebsiteStallDetailTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->WebsiteStallDetail = ClassRegistry::init('WebsiteStallDetail');
	}

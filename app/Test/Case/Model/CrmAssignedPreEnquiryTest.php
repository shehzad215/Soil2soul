<?php
App::uses('CrmAssignedPreEnquiry', 'Model');

/**
 * CrmAssignedPreEnquiry Test Case
 *
 */
class CrmAssignedPreEnquiryTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->CrmAssignedPreEnquiry = ClassRegistry::init('CrmAssignedPreEnquiry');
	}
 ...
 */
	public function tearDown() {
		unset($this->CrmAssignedPreEnquiry);

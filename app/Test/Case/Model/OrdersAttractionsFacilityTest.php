<?php
App::uses('OrdersAttractionsFacility', 'Model');

/**
 * OrdersAttractionsFacility Test Case
 *
 */
class OrdersAttractionsFacilityTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->OrdersAttractionsFacility = ClassRegistry::init('OrdersAttractionsFacility');
	}
 ...
 */
	public function tearDown() {
		unset($this->OrdersAttractionsFacility);

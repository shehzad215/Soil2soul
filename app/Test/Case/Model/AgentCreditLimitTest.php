<?php
App::uses('AgentCreditLimit', 'Model');

/**
 * AgentCreditLimit Test Case
 *
 */
class AgentCreditLimitTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->AgentCreditLimit = ClassRegistry::init('AgentCreditLimit');
	}

<?php
App::uses('OrderSpecificPrice', 'Model');

/**
 * OrderSpecificPrice Test Case
 *
 */
class OrderSpecificPriceTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->OrderSpecificPrice = ClassRegistry::init('OrderSpecificPrice');
	}

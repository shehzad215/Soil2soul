<?php
App::uses('EventSpeedNet', 'Model');

/**
 * EventSpeedNet Test Case
 *
 */
class EventSpeedNetTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->EventSpeedNet = ClassRegistry::init('EventSpeedNet');
	}

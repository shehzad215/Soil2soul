<?php
App::uses('OrderAttractionProductPickupPoint', 'Model');

/**
 * OrderAttractionProductPickupPoint Test Case
 *
 */
class OrderAttractionProductPickupPointTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->OrderAttractionProductPickupPoint = ClassRegistry::init('OrderAttractionProductPickupPoint');
	}
 ...
 */
	public function tearDown() {
		unset($this->OrderAttractionProductPickupPoint);

<?php
App::uses('CrmAssignedLead', 'Model');

/**
 * CrmAssignedLead Test Case
 *
 */
class CrmAssignedLeadTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->CrmAssignedLead = ClassRegistry::init('CrmAssignedLead');
	}

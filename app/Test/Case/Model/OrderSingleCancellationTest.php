<?php
App::uses('OrderSingleCancellation', 'Model');

/**
 * OrderSingleCancellation Test Case
 *
 */
class OrderSingleCancellationTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->OrderSingleCancellation = ClassRegistry::init('OrderSingleCancellation');
	}
 ...
 */
	public function tearDown() {
		unset($this->OrderSingleCancellation);

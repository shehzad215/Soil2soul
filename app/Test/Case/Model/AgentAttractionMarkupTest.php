<?php
App::uses('AgentAttractionMarkup', 'Model');

/**
 * AgentAttractionMarkup Test Case
 *
 */
class AgentAttractionMarkupTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->AgentAttractionMarkup = ClassRegistry::init('AgentAttractionMarkup');
	}
 ...
 */
	public function tearDown() {
		unset($this->AgentAttractionMarkup);

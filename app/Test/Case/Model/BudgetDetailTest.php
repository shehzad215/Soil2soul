<?php
App::uses('BudgetDetail', 'Model');

/**
 * BudgetDetail Test Case
 *
 */
class BudgetDetailTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->BudgetDetail = ClassRegistry::init('BudgetDetail');
	}

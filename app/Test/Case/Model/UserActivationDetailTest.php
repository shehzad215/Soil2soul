<?php
App::uses('UserActivationDetail', 'Model');

/**
 * UserActivationDetail Test Case
 *
 */
class UserActivationDetailTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->UserActivationDetail = ClassRegistry::init('UserActivationDetail');
	}
 ...
 */
	public function tearDown() {
		unset($this->UserActivationDetail);

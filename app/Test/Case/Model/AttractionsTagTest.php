<?php
App::uses('AttractionsTag', 'Model');

/**
 * AttractionsTag Test Case
 *
 */
class AttractionsTagTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->AttractionsTag = ClassRegistry::init('AttractionsTag');
	}

<?php
App::uses('UserWorksheet', 'Model');

/**
 * UserWorksheet Test Case
 *
 */
class UserWorksheetTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->UserWorksheet = ClassRegistry::init('UserWorksheet');
	}

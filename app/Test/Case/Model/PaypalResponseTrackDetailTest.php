<?php
App::uses('PaypalResponseTrackDetail', 'Model');

/**
 * PaypalResponseTrackDetail Test Case
 *
 */
class PaypalResponseTrackDetailTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->PaypalResponseTrackDetail = ClassRegistry::init('PaypalResponseTrackDetail');
	}
 ...
 */
	public function tearDown() {
		unset($this->PaypalResponseTrackDetail);

<?php
App::uses('AttractionProduct', 'Model');

/**
 * AttractionProduct Test Case
 *
 */
class AttractionProductTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->AttractionProduct = ClassRegistry::init('AttractionProduct');
	}

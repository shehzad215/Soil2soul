<?php
App::uses('UserSubscription', 'Model');

/**
 * UserSubscription Test Case
 *
 */
class UserSubscriptionTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->UserSubscription = ClassRegistry::init('UserSubscription');
	}

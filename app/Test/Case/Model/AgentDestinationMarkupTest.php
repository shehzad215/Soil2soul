<?php
App::uses('AgentDestinationMarkup', 'Model');

/**
 * AgentDestinationMarkup Test Case
 *
 */
class AgentDestinationMarkupTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->AgentDestinationMarkup = ClassRegistry::init('AgentDestinationMarkup');
	}
 ...
 */
	public function tearDown() {
		unset($this->AgentDestinationMarkup);

<?php
App::uses('OrdersFacility', 'Model');

/**
 * OrdersFacility Test Case
 *
 */
class OrdersFacilityTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->OrdersFacility = ClassRegistry::init('OrdersFacility');
	}

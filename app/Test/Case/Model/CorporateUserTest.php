<?php
App::uses('CorporateUser', 'Model');

/**
 * CorporateUser Test Case
 *
 */
class CorporateUserTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->CorporateUser = ClassRegistry::init('CorporateUser');
	}

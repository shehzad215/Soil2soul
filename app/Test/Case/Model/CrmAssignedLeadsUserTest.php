<?php
App::uses('CrmAssignedLeadsUser', 'Model');

/**
 * CrmAssignedLeadsUser Test Case
 *
 */
class CrmAssignedLeadsUserTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->CrmAssignedLeadsUser = ClassRegistry::init('CrmAssignedLeadsUser');
	}
 ...
 */
	public function tearDown() {
		unset($this->CrmAssignedLeadsUser);

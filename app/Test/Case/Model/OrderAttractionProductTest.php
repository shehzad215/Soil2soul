<?php
App::uses('OrderAttractionProduct', 'Model');

/**
 * OrderAttractionProduct Test Case
 *
 */
class OrderAttractionProductTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->OrderAttractionProduct = ClassRegistry::init('OrderAttractionProduct');
	}
 ...
 */
	public function tearDown() {
		unset($this->OrderAttractionProduct);

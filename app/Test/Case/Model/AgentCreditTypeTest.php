<?php
App::uses('AgentCreditType', 'Model');

/**
 * AgentCreditType Test Case
 *
 */
class AgentCreditTypeTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->AgentCreditType = ClassRegistry::init('AgentCreditType');
	}

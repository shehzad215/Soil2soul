<?php
App::uses('OrderAgentCreditPayementHistory', 'Model');

/**
 * OrderAgentCreditPayementHistory Test Case
 *
 */
class OrderAgentCreditPayementHistoryTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->OrderAgentCreditPayementHistory = ClassRegistry::init('OrderAgentCreditPayementHistory');
	}
 ...
 */
	public function tearDown() {
		unset($this->OrderAgentCreditPayementHistory);

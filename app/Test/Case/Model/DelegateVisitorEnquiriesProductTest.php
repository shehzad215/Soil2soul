<?php
App::uses('DelegateVisitorEnquiriesProduct', 'Model');

/**
 * DelegateVisitorEnquiriesProduct Test Case
 *
 */
class DelegateVisitorEnquiriesProductTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->DelegateVisitorEnquiriesProduct = ClassRegistry::init('DelegateVisitorEnquiriesProduct');
	}
 ...
 */
	public function tearDown() {
		unset($this->DelegateVisitorEnquiriesProduct);

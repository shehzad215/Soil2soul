<?php
App::uses('CrmQuoteRequestProductFeature', 'Model');

/**
 * CrmQuoteRequestProductFeature Test Case
 *
 */
class CrmQuoteRequestProductFeatureTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->CrmQuoteRequestProductFeature = ClassRegistry::init('CrmQuoteRequestProductFeature');
	}
 ...
 */
	public function tearDown() {
		unset($this->CrmQuoteRequestProductFeature);

<?php
App::uses('UserSocialProfile', 'Model');

/**
 * UserSocialProfile Test Case
 *
 */
class UserSocialProfileTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->UserSocialProfile = ClassRegistry::init('UserSocialProfile');
	}

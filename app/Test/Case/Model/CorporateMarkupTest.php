<?php
App::uses('CorporateMarkup', 'Model');

/**
 * CorporateMarkup Test Case
 *
 */
class CorporateMarkupTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->CorporateMarkup = ClassRegistry::init('CorporateMarkup');
	}

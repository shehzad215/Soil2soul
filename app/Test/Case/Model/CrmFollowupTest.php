<?php
App::uses('CrmFollowup', 'Model');

/**
 * CrmFollowup Test Case
 *
 */
class CrmFollowupTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->CrmFollowup = ClassRegistry::init('CrmFollowup');
	}

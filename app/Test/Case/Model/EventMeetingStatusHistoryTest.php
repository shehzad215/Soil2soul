<?php
App::uses('EventMeetingStatusHistory', 'Model');

/**
 * EventMeetingStatusHistory Test Case
 *
 */
class EventMeetingStatusHistoryTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->EventMeetingStatusHistory = ClassRegistry::init('EventMeetingStatusHistory');
	}
 ...
 */
	public function tearDown() {
		unset($this->EventMeetingStatusHistory);

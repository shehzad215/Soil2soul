<?php
App::uses('EnquirySourceTypeDetail', 'Model');

/**
 * EnquirySourceTypeDetail Test Case
 *
 */
class EnquirySourceTypeDetailTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->EnquirySourceTypeDetail = ClassRegistry::init('EnquirySourceTypeDetail');
	}
 ...
 */
	public function tearDown() {
		unset($this->EnquirySourceTypeDetail);

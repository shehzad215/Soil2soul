<?php
App::uses('CrmFollowupAttachment', 'Model');

/**
 * CrmFollowupAttachment Test Case
 *
 */
class CrmFollowupAttachmentTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->CrmFollowupAttachment = ClassRegistry::init('CrmFollowupAttachment');
	}
 ...
 */
	public function tearDown() {
		unset($this->CrmFollowupAttachment);

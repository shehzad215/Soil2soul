<?php
App::uses('BookingPortal', 'Model');

/**
 * BookingPortal Test Case
 *
 */
class BookingPortalTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->BookingPortal = ClassRegistry::init('BookingPortal');
	}

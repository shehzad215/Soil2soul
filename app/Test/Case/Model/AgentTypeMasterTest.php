<?php
App::uses('AgentTypeMaster', 'Model');

/**
 * AgentTypeMaster Test Case
 *
 */
class AgentTypeMasterTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->AgentTypeMaster = ClassRegistry::init('AgentTypeMaster');
	}

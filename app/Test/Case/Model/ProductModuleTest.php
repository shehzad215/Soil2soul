<?php
App::uses('ProductModule', 'Model');

/**
 * ProductModule Test Case
 *
 */
class ProductModuleTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->ProductModule = ClassRegistry::init('ProductModule');
	}

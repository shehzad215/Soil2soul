<?php
App::uses('DelegateVisitorEnquiryDetail', 'Model');

/**
 * DelegateVisitorEnquiryDetail Test Case
 *
 */
class DelegateVisitorEnquiryDetailTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->DelegateVisitorEnquiryDetail = ClassRegistry::init('DelegateVisitorEnquiryDetail');
	}
 ...
 */
	public function tearDown() {
		unset($this->DelegateVisitorEnquiryDetail);

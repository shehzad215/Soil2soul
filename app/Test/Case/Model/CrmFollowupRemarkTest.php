<?php
App::uses('CrmFollowupRemark', 'Model');

/**
 * CrmFollowupRemark Test Case
 *
 */
class CrmFollowupRemarkTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->CrmFollowupRemark = ClassRegistry::init('CrmFollowupRemark');
	}

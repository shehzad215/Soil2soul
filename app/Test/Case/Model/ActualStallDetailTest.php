<?php
App::uses('ActualStallDetail', 'Model');

/**
 * ActualStallDetail Test Case
 *
 */
class ActualStallDetailTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->ActualStallDetail = ClassRegistry::init('ActualStallDetail');
	}

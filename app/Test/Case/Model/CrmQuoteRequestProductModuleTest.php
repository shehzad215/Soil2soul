<?php
App::uses('CrmQuoteRequestProductModule', 'Model');

/**
 * CrmQuoteRequestProductModule Test Case
 *
 */
class CrmQuoteRequestProductModuleTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->CrmQuoteRequestProductModule = ClassRegistry::init('CrmQuoteRequestProductModule');
	}
 ...
 */
	public function tearDown() {
		unset($this->CrmQuoteRequestProductModule);

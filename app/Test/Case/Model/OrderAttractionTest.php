<?php
App::uses('OrderAttraction', 'Model');

/**
 * OrderAttraction Test Case
 *
 */
class OrderAttractionTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->OrderAttraction = ClassRegistry::init('OrderAttraction');
	}

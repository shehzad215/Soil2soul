<?php
App::uses('EfewaRequestedDemo', 'Model');

/**
 * EfewaRequestedDemo Test Case
 *
 */
class EfewaRequestedDemoTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->EfewaRequestedDemo = ClassRegistry::init('EfewaRequestedDemo');
	}

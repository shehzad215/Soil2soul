<?php
App::uses('AttractionQuestion', 'Model');

/**
 * AttractionQuestion Test Case
 *
 */
class AttractionQuestionTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->AttractionQuestion = ClassRegistry::init('AttractionQuestion');
	}

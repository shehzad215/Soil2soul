<?php
App::uses('OrderAttractionVideo', 'Model');

/**
 * OrderAttractionVideo Test Case
 *
 */
class OrderAttractionVideoTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->OrderAttractionVideo = ClassRegistry::init('OrderAttractionVideo');
	}
 ...
 */
	public function tearDown() {
		unset($this->OrderAttractionVideo);

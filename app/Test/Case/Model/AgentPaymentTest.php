<?php
App::uses('AgentPayment', 'Model');

/**
 * AgentPayment Test Case
 *
 */
class AgentPaymentTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->AgentPayment = ClassRegistry::init('AgentPayment');
	}

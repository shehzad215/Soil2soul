<?php
App::uses('ProductVariant', 'Model');

/**
 * ProductVariant Test Case
 *
 */
class ProductVariantTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->ProductVariant = ClassRegistry::init('ProductVariant');
	}

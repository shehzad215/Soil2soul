<?php
App::uses('CrmSubStage', 'Model');

/**
 * CrmSubStage Test Case
 *
 */
class CrmSubStageTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->CrmSubStage = ClassRegistry::init('CrmSubStage');
	}

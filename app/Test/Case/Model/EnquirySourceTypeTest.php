<?php
App::uses('EnquirySourceType', 'Model');

/**
 * EnquirySourceType Test Case
 *
 */
class EnquirySourceTypeTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->EnquirySourceType = ClassRegistry::init('EnquirySourceType');
	}

<?php
App::uses('AttractionProductQuestion', 'Model');

/**
 * AttractionProductQuestion Test Case
 *
 */
class AttractionProductQuestionTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->AttractionProductQuestion = ClassRegistry::init('AttractionProductQuestion');
	}
 ...
 */
	public function tearDown() {
		unset($this->AttractionProductQuestion);

<?php
App::uses('OrderAttractionType', 'Model');

/**
 * OrderAttractionType Test Case
 *
 */
class OrderAttractionTypeTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->OrderAttractionType = ClassRegistry::init('OrderAttractionType');
	}
 ...
 */
	public function tearDown() {
		unset($this->OrderAttractionType);

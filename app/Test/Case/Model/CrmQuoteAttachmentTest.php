<?php
App::uses('CrmQuoteAttachment', 'Model');

/**
 * CrmQuoteAttachment Test Case
 *
 */
class CrmQuoteAttachmentTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->CrmQuoteAttachment = ClassRegistry::init('CrmQuoteAttachment');
	}

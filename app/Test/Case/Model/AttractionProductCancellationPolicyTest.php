<?php
App::uses('AttractionProductCancellationPolicy', 'Model');

/**
 * AttractionProductCancellationPolicy Test Case
 *
 */
class AttractionProductCancellationPolicyTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->AttractionProductCancellationPolicy = ClassRegistry::init('AttractionProductCancellationPolicy');
	}
 ...
 */
	public function tearDown() {
		unset($this->AttractionProductCancellationPolicy);

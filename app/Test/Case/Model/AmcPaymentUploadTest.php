<?php
App::uses('AmcPaymentUpload', 'Model');

/**
 * AmcPaymentUpload Test Case
 *
 */
class AmcPaymentUploadTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->AmcPaymentUpload = ClassRegistry::init('AmcPaymentUpload');
	}

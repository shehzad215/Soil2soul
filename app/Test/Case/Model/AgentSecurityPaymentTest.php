<?php
App::uses('AgentSecurityPayment', 'Model');

/**
 * AgentSecurityPayment Test Case
 *
 */
class AgentSecurityPaymentTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->AgentSecurityPayment = ClassRegistry::init('AgentSecurityPayment');
	}
 ...
 */
	public function tearDown() {
		unset($this->AgentSecurityPayment);

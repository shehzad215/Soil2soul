<?php
App::uses('OrderProductPrice', 'Model');

/**
 * OrderProductPrice Test Case
 *
 */
class OrderProductPriceTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->OrderProductPrice = ClassRegistry::init('OrderProductPrice');
	}

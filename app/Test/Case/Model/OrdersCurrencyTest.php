<?php
App::uses('OrdersCurrency', 'Model');

/**
 * OrdersCurrency Test Case
 *
 */
class OrdersCurrencyTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->OrdersCurrency = ClassRegistry::init('OrdersCurrency');
	}

<?php
App::uses('OrderCancellation', 'Model');

/**
 * OrderCancellation Test Case
 *
 */
class OrderCancellationTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->OrderCancellation = ClassRegistry::init('OrderCancellation');
	}

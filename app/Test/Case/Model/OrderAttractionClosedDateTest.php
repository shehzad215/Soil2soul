<?php
App::uses('OrderAttractionClosedDate', 'Model');

/**
 * OrderAttractionClosedDate Test Case
 *
 */
class OrderAttractionClosedDateTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->OrderAttractionClosedDate = ClassRegistry::init('OrderAttractionClosedDate');
	}
 ...
 */
	public function tearDown() {
		unset($this->OrderAttractionClosedDate);

<?php
App::uses('MostViewedAttraction', 'Model');

/**
 * MostViewedAttraction Test Case
 *
 */
class MostViewedAttractionTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->MostViewedAttraction = ClassRegistry::init('MostViewedAttraction');
	}
 ...
 */
	public function tearDown() {
		unset($this->MostViewedAttraction);

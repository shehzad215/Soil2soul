<?php
App::uses('EventTimetableSetup', 'Model');

/**
 * EventTimetableSetup Test Case
 *
 */
class EventTimetableSetupTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->EventTimetableSetup = ClassRegistry::init('EventTimetableSetup');
	}
 ...
 */
	public function tearDown() {
		unset($this->EventTimetableSetup);

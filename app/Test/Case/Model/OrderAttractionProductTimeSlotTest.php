<?php
App::uses('OrderAttractionProductTimeSlot', 'Model');

/**
 * OrderAttractionProductTimeSlot Test Case
 *
 */
class OrderAttractionProductTimeSlotTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->OrderAttractionProductTimeSlot = ClassRegistry::init('OrderAttractionProductTimeSlot');
	}
 ...
 */
	public function tearDown() {
		unset($this->OrderAttractionProductTimeSlot);

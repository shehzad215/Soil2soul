<?php
App::uses('OrderAttractionProductQuestion', 'Model');

/**
 * OrderAttractionProductQuestion Test Case
 *
 */
class OrderAttractionProductQuestionTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->OrderAttractionProductQuestion = ClassRegistry::init('OrderAttractionProductQuestion');
	}
 ...
 */
	public function tearDown() {
		unset($this->OrderAttractionProductQuestion);

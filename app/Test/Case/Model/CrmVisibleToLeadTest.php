<?php
App::uses('CrmVisibleToLead', 'Model');

/**
 * CrmVisibleToLead Test Case
 *
 */
class CrmVisibleToLeadTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->CrmVisibleToLead = ClassRegistry::init('CrmVisibleToLead');
	}

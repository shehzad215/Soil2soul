<?php
App::uses('OrderAttractionRegularTiming', 'Model');

/**
 * OrderAttractionRegularTiming Test Case
 *
 */
class OrderAttractionRegularTimingTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->OrderAttractionRegularTiming = ClassRegistry::init('OrderAttractionRegularTiming');
	}
 ...
 */
	public function tearDown() {
		unset($this->OrderAttractionRegularTiming);

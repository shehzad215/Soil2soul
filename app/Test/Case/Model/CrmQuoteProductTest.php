<?php
App::uses('CrmQuoteProduct', 'Model');

/**
 * CrmQuoteProduct Test Case
 *
 */
class CrmQuoteProductTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->CrmQuoteProduct = ClassRegistry::init('CrmQuoteProduct');
	}

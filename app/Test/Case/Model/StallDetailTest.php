<?php
App::uses('StallDetail', 'Model');

/**
 * StallDetail Test Case
 *
 */
class StallDetailTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->StallDetail = ClassRegistry::init('StallDetail');
	}

<?php
App::uses('ServicePaymentUpload', 'Model');

/**
 * ServicePaymentUpload Test Case
 *
 */
class ServicePaymentUploadTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->ServicePaymentUpload = ClassRegistry::init('ServicePaymentUpload');
	}
 ...
 */
	public function tearDown() {
		unset($this->ServicePaymentUpload);

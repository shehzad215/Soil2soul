<?php
App::uses('OrderAttractionProductCommentByHotelBed', 'Model');

/**
 * OrderAttractionProductCommentByHotelBed Test Case
 *
 */
class OrderAttractionProductCommentByHotelBedTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->OrderAttractionProductCommentByHotelBed = ClassRegistry::init('OrderAttractionProductCommentByHotelBed');
	}
 ...
 */
	public function tearDown() {
		unset($this->OrderAttractionProductCommentByHotelBed);

<?php
App::uses('PreEnquiryTransferReceiveHistory', 'Model');

/**
 * PreEnquiryTransferReceiveHistory Test Case
 *
 */
class PreEnquiryTransferReceiveHistoryTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->PreEnquiryTransferReceiveHistory = ClassRegistry::init('PreEnquiryTransferReceiveHistory');
	}
 ...
 */
	public function tearDown() {
		unset($this->PreEnquiryTransferReceiveHistory);

<?php
App::uses('OrderDuration', 'Model');

/**
 * OrderDuration Test Case
 *
 */
class OrderDurationTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->OrderDuration = ClassRegistry::init('OrderDuration');
	}

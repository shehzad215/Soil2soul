<?php
App::uses('OrdersCategory', 'Model');

/**
 * OrdersCategory Test Case
 *
 */
class OrdersCategoryTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->OrdersCategory = ClassRegistry::init('OrdersCategory');
	}

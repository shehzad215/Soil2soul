<?php
App::uses('EventVisitor', 'Model');

/**
 * EventVisitor Test Case
 *
 */
class EventVisitorTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->EventVisitor = ClassRegistry::init('EventVisitor');
	}

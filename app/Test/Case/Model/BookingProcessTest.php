<?php
App::uses('BookingProcess', 'Model');

/**
 * BookingProcess Test Case
 *
 */
class BookingProcessTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->BookingProcess = ClassRegistry::init('BookingProcess');
	}

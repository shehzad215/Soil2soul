<?php
App::uses('AttractionOrderStatus', 'Model');

/**
 * AttractionOrderStatus Test Case
 *
 */
class AttractionOrderStatusTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->AttractionOrderStatus = ClassRegistry::init('AttractionOrderStatus');
	}
 ...
 */
	public function tearDown() {
		unset($this->AttractionOrderStatus);

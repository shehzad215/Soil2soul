<?php
App::uses('EventMeetingStatus', 'Model');

/**
 * EventMeetingStatus Test Case
 *
 */
class EventMeetingStatusTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->EventMeetingStatus = ClassRegistry::init('EventMeetingStatus');
	}

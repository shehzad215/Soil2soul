<?php
App::uses('OrdersAttractionsFacilitiesController', 'Controller');

/**
 * OrdersAttractionsFacilitiesController Test Case
 *
 */
class OrdersAttractionsFacilitiesControllerTest extends ControllerTestCase {

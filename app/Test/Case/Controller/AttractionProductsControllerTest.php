<?php
App::uses('AttractionProductsController', 'Controller');

/**
 * AttractionProductsController Test Case
 *
 */
class AttractionProductsControllerTest extends ControllerTestCase {

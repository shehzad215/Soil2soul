<?php
App::uses('OrderSingleCancellationsController', 'Controller');

/**
 * OrderSingleCancellationsController Test Case
 *
 */
class OrderSingleCancellationsControllerTest extends ControllerTestCase {

<?php
App::uses('ProductPresentationsController', 'Controller');

/**
 * ProductPresentationsController Test Case
 *
 */
class ProductPresentationsControllerTest extends ControllerTestCase {

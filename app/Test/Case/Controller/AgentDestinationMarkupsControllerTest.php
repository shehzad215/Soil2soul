<?php
App::uses('AgentDestinationMarkupsController', 'Controller');

/**
 * AgentDestinationMarkupsController Test Case
 *
 */
class AgentDestinationMarkupsControllerTest extends ControllerTestCase {

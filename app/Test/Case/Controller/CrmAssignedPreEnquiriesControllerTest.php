<?php
App::uses('CrmAssignedPreEnquiriesController', 'Controller');

/**
 * CrmAssignedPreEnquiriesController Test Case
 *
 */
class CrmAssignedPreEnquiriesControllerTest extends ControllerTestCase {

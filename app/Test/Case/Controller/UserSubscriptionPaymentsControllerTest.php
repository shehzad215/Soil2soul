<?php
App::uses('UserSubscriptionPaymentsController', 'Controller');

/**
 * UserSubscriptionPaymentsController Test Case
 *
 */
class UserSubscriptionPaymentsControllerTest extends ControllerTestCase {

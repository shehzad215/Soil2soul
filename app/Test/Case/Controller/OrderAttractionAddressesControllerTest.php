<?php
App::uses('OrderAttractionAddressesController', 'Controller');

/**
 * OrderAttractionAddressesController Test Case
 *
 */
class OrderAttractionAddressesControllerTest extends ControllerTestCase {

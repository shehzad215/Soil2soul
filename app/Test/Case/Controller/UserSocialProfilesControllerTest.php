<?php
App::uses('UserSocialProfilesController', 'Controller');

/**
 * UserSocialProfilesController Test Case
 *
 */
class UserSocialProfilesControllerTest extends ControllerTestCase {

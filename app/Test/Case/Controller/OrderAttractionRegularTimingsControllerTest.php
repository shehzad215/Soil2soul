<?php
App::uses('OrderAttractionRegularTimingsController', 'Controller');

/**
 * OrderAttractionRegularTimingsController Test Case
 *
 */
class OrderAttractionRegularTimingsControllerTest extends ControllerTestCase {

<?php
App::uses('OrdersAttractionsCategoriesController', 'Controller');

/**
 * OrdersAttractionsCategoriesController Test Case
 *
 */
class OrdersAttractionsCategoriesControllerTest extends ControllerTestCase {

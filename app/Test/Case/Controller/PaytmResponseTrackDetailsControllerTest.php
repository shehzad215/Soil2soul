<?php
App::uses('PaytmResponseTrackDetailsController', 'Controller');

/**
 * PaytmResponseTrackDetailsController Test Case
 *
 */
class PaytmResponseTrackDetailsControllerTest extends ControllerTestCase {

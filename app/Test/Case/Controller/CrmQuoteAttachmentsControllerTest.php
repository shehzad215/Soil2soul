<?php
App::uses('CrmQuoteAttachmentsController', 'Controller');

/**
 * CrmQuoteAttachmentsController Test Case
 *
 */
class CrmQuoteAttachmentsControllerTest extends ControllerTestCase {

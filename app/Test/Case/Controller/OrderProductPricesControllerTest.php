<?php
App::uses('OrderProductPricesController', 'Controller');

/**
 * OrderProductPricesController Test Case
 *
 */
class OrderProductPricesControllerTest extends ControllerTestCase {

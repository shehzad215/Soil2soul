<?php
App::uses('WebsiteStallDetailsController', 'Controller');

/**
 * WebsiteStallDetailsController Test Case
 *
 */
class WebsiteStallDetailsControllerTest extends ControllerTestCase {

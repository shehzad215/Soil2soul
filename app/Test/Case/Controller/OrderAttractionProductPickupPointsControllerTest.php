<?php
App::uses('OrderAttractionProductPickupPointsController', 'Controller');

/**
 * OrderAttractionProductPickupPointsController Test Case
 *
 */
class OrderAttractionProductPickupPointsControllerTest extends ControllerTestCase {

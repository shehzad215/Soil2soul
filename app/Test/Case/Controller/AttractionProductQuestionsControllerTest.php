<?php
App::uses('AttractionProductQuestionsController', 'Controller');

/**
 * AttractionProductQuestionsController Test Case
 *
 */
class AttractionProductQuestionsControllerTest extends ControllerTestCase {

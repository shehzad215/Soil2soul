<?php
App::uses('AttractionQuestionsController', 'Controller');

/**
 * AttractionQuestionsController Test Case
 *
 */
class AttractionQuestionsControllerTest extends ControllerTestCase {

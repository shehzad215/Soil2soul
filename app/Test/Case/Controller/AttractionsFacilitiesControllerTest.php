<?php
App::uses('AttractionsFacilitiesController', 'Controller');

/**
 * AttractionsFacilitiesController Test Case
 *
 */
class AttractionsFacilitiesControllerTest extends ControllerTestCase {

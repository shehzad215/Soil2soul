<?php
App::uses('AgentSecurityPaymentsController', 'Controller');

/**
 * AgentSecurityPaymentsController Test Case
 *
 */
class AgentSecurityPaymentsControllerTest extends ControllerTestCase {

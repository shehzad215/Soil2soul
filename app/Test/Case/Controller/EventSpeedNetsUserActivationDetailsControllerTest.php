<?php
App::uses('EventSpeedNetsUserActivationDetailsController', 'Controller');

/**
 * EventSpeedNetsUserActivationDetailsController Test Case
 *
 */
class EventSpeedNetsUserActivationDetailsControllerTest extends ControllerTestCase {

<?php
App::uses('AttractionProductCancellationPoliciesController', 'Controller');

/**
 * AttractionProductCancellationPoliciesController Test Case
 *
 */
class AttractionProductCancellationPoliciesControllerTest extends ControllerTestCase {

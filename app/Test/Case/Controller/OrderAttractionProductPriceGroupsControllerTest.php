<?php
App::uses('OrderAttractionProductPriceGroupsController', 'Controller');

/**
 * OrderAttractionProductPriceGroupsController Test Case
 *
 */
class OrderAttractionProductPriceGroupsControllerTest extends ControllerTestCase {

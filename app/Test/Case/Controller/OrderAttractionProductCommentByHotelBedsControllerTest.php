<?php
App::uses('OrderAttractionProductCommentByHotelBedsController', 'Controller');

/**
 * OrderAttractionProductCommentByHotelBedsController Test Case
 *
 */
class OrderAttractionProductCommentByHotelBedsControllerTest extends ControllerTestCase {

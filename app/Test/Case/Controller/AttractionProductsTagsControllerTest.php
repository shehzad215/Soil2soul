<?php
App::uses('AttractionProductsTagsController', 'Controller');

/**
 * AttractionProductsTagsController Test Case
 *
 */
class AttractionProductsTagsControllerTest extends ControllerTestCase {

<?php
App::uses('OrderAttractionProductCancellationPoliciesController', 'Controller');

/**
 * OrderAttractionProductCancellationPoliciesController Test Case
 *
 */
class OrderAttractionProductCancellationPoliciesControllerTest extends ControllerTestCase {

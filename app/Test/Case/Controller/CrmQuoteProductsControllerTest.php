<?php
App::uses('CrmQuoteProductsController', 'Controller');

/**
 * CrmQuoteProductsController Test Case
 *
 */
class CrmQuoteProductsControllerTest extends ControllerTestCase {

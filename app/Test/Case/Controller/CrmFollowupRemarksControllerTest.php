<?php
App::uses('CrmFollowupRemarksController', 'Controller');

/**
 * CrmFollowupRemarksController Test Case
 *
 */
class CrmFollowupRemarksControllerTest extends ControllerTestCase {

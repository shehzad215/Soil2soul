<?php
App::uses('OrderAttractionVideosController', 'Controller');

/**
 * OrderAttractionVideosController Test Case
 *
 */
class OrderAttractionVideosControllerTest extends ControllerTestCase {

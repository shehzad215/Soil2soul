<?php
App::uses('OurJourneyDeparturesController', 'Controller');

/**
 * OurJourneyDeparturesController Test Case
 *
 */
class OurJourneyDeparturesControllerTest extends ControllerTestCase {

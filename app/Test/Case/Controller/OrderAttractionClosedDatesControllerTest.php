<?php
App::uses('OrderAttractionClosedDatesController', 'Controller');

/**
 * OrderAttractionClosedDatesController Test Case
 *
 */
class OrderAttractionClosedDatesControllerTest extends ControllerTestCase {

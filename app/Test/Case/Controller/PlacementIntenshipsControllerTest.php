<?php
App::uses('PlacementIntenshipsController', 'Controller');

/**
 * PlacementIntenshipsController Test Case
 *
 */
class PlacementIntenshipsControllerTest extends ControllerTestCase {

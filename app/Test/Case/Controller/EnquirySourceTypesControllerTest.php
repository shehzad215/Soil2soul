<?php
App::uses('EnquirySourceTypesController', 'Controller');

/**
 * EnquirySourceTypesController Test Case
 *
 */
class EnquirySourceTypesControllerTest extends ControllerTestCase {

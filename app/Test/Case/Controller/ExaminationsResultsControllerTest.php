<?php
App::uses('ExaminationsResultsController', 'Controller');

/**
 * ExaminationsResultsController Test Case
 *
 */
class ExaminationsResultsControllerTest extends ControllerTestCase {

<?php
App::uses('AttractionOrderStatusesController', 'Controller');

/**
 * AttractionOrderStatusesController Test Case
 *
 */
class AttractionOrderStatusesControllerTest extends ControllerTestCase {

<?php
App::uses('OrderProductPriceGroupsController', 'Controller');

/**
 * OrderProductPriceGroupsController Test Case
 *
 */
class OrderProductPriceGroupsControllerTest extends ControllerTestCase {

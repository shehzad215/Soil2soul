<?php
App::uses('OrderCancellationsController', 'Controller');

/**
 * OrderCancellationsController Test Case
 *
 */
class OrderCancellationsControllerTest extends ControllerTestCase {

<?php
App::uses('OrderAttractionsController', 'Controller');

/**
 * OrderAttractionsController Test Case
 *
 */
class OrderAttractionsControllerTest extends ControllerTestCase {

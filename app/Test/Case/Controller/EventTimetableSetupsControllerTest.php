<?php
App::uses('EventTimetableSetupsController', 'Controller');

/**
 * EventTimetableSetupsController Test Case
 *
 */
class EventTimetableSetupsControllerTest extends ControllerTestCase {

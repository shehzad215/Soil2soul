<?php
App::uses('EventMeetingStatusHistoriesController', 'Controller');

/**
 * EventMeetingStatusHistoriesController Test Case
 *
 */
class EventMeetingStatusHistoriesControllerTest extends ControllerTestCase {

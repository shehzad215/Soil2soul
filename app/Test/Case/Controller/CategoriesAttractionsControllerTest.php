<?php
App::uses('CategoriesAttractionsController', 'Controller');

/**
 * CategoriesAttractionsController Test Case
 *
 */
class CategoriesAttractionsControllerTest extends ControllerTestCase {

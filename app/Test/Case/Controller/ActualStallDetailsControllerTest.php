<?php
App::uses('ActualStallDetailsController', 'Controller');

/**
 * ActualStallDetailsController Test Case
 *
 */
class ActualStallDetailsControllerTest extends ControllerTestCase {

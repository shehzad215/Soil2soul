<?php
App::uses('DelegateVisitorEnquiriesProductsController', 'Controller');

/**
 * DelegateVisitorEnquiriesProductsController Test Case
 *
 */
class DelegateVisitorEnquiriesProductsControllerTest extends ControllerTestCase {

<?php
App::uses('UserActivationDetailsController', 'Controller');

/**
 * UserActivationDetailsController Test Case
 *
 */
class UserActivationDetailsControllerTest extends ControllerTestCase {

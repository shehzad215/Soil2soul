<?php
App::uses('FeaturedAttractionsController', 'Controller');

/**
 * FeaturedAttractionsController Test Case
 *
 */
class FeaturedAttractionsControllerTest extends ControllerTestCase {

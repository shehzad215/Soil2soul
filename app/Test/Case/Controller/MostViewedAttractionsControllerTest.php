<?php
App::uses('MostViewedAttractionsController', 'Controller');

/**
 * MostViewedAttractionsController Test Case
 *
 */
class MostViewedAttractionsControllerTest extends ControllerTestCase {

<?php
App::uses('OrderSpecificPricesController', 'Controller');

/**
 * OrderSpecificPricesController Test Case
 *
 */
class OrderSpecificPricesControllerTest extends ControllerTestCase {

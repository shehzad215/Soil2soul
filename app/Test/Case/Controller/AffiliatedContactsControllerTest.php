<?php
App::uses('AffiliatedContactsController', 'Controller');

/**
 * AffiliatedContactsController Test Case
 *
 */
class AffiliatedContactsControllerTest extends ControllerTestCase {

<?php
App::uses('EnquirySourceTypeDetailsController', 'Controller');

/**
 * EnquirySourceTypeDetailsController Test Case
 *
 */
class EnquirySourceTypeDetailsControllerTest extends ControllerTestCase {
 ...
 */
	public $fixtures = array(
		'app.enquiry_source_type_detail',
		...
		'app.crm_quote_request_product_module',
		'app.crm_quote_request_product_feature',
		'app.amc_term',

<?php
App::uses('OrderAttractionProductTimeSlotsController', 'Controller');

/**
 * OrderAttractionProductTimeSlotsController Test Case
 *
 */
class OrderAttractionProductTimeSlotsControllerTest extends ControllerTestCase {

<?php
App::uses('AgentAttractionMarkupsController', 'Controller');

/**
 * AgentAttractionMarkupsController Test Case
 *
 */
class AgentAttractionMarkupsControllerTest extends ControllerTestCase {

<?php
App::uses('CrmFollowupAttachmentsController', 'Controller');

/**
 * CrmFollowupAttachmentsController Test Case
 *
 */
class CrmFollowupAttachmentsControllerTest extends ControllerTestCase {

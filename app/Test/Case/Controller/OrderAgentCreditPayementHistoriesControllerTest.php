<?php
App::uses('OrderAgentCreditPayementHistoriesController', 'Controller');

/**
 * OrderAgentCreditPayementHistoriesController Test Case
 *
 */
class OrderAgentCreditPayementHistoriesControllerTest extends ControllerTestCase {

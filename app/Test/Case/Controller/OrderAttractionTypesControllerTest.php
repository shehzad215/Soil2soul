<?php
App::uses('OrderAttractionTypesController', 'Controller');

/**
 * OrderAttractionTypesController Test Case
 *
 */
class OrderAttractionTypesControllerTest extends ControllerTestCase {

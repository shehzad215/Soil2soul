...
<div class="taglineicon"><img src="<?php echo $this->webroot;?>img/taglineicon.png" alt="soil-2-soul-lotus-logo" title="Soil 2 Soul : expeditions"></div>	
<h1>Transformative journeys <br>
...
<div class=""><img src="<?php echo $this->webroot;?>img/elephant_leftw.png"  alt="soil-2-soul-elephant"/> &nbsp;
 <a href="<?php echo Router::url('/our_journeys'); ?>"><button type="button" class="explorebtn">Explore</button></a> &nbsp; <img src="<?php echo $this->webroot;?>img/elephant_rightw.png"  alt="soil-2-soul-elephant"/></div>	
</div>	
</div>	
</div>
<!--Tagline end here-->	
...
<img src="<?php echo $this->webroot;?>img/om.png" alt="soil-2-soul-Om-logo"/><br>
<br>
<span>Soil 2 Soul Expeditions </span> offers a scholar led transformative journey that encourages self-reflection, <br class="hidden-sm hidden-xs">
mindfulness, and personal growth, fostering a sense of purpose and fulfilment. We are proud to introduce<br>
<span>"Transformative Journeys to Sacred India / Bharat," </span> a pioneering initiative aimed at offering seekers an  <br class="hidden-sm hidden-xs">
opportunity to explore India's sacred places in a profound and insightful way.</div>
</div>
<div class="wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">	
...
<div class="text-center"><img src="<?php echo $this->webroot;?>img/elephant_left.png"  alt="soil-2-soul-elephant"/> &nbsp; <a href="<?php echo Router::url('/about-us'); ?>"><button type="button" class="viewallbtn">Learn More</button></a> &nbsp; <img src="<?php echo $this->webroot;?>img/elephant_right.png" alt="soil-2-soul-elephant"/></div>
</div>	
	
	
<!-- Our journey Packge Start Hew -->	
<?php 
if(!empty($packages)){echo $this->element('HomePage/our_journey');}
?>	
</section>	
<!--Our Journeys end here-->

<?php //debug($otherPosts); die; ?>

<!-- post of the week start -->
<?php if(!empty($otherPosts)) { ?>
<div class="postofweekbg">
 <div class="container">
<div class="wow slideInUp" style="visibility: visible; animation-name: slideInUp;">
<div class=""><img src="img/logoshape_heading.png" class="img-responsive center-block"></div>	
<div class="mainheading text-center"><h2>Posts of the Week</h2></div>
</div>	
<div class="wow slideInUp" style="visibility: visible; animation-name: slideInUp;">
<div class="row">


<?php foreach ($otherPosts as $key => $otherPost) { ?>
<div class="col-sm-6">
<div class="postbox">
<div class="row">
<div class="col-sm-5">
<div class="potsboximg"> <a href="<?php echo $otherPost['Video']['video_link'];  ?>" target="_blank">
	<?php echo $this->Bs->image('Video.image_file',$otherPost,['alt'=>$otherPost['Video']['title']]) ?>
	<img src="<?php echo $this->webroot;?>img/anupjalota.jpg" alt=""/>
</a> </div>    
</div>
<div class="col-sm-7 content3">
<?php
$description = $otherPost['Video']['description'];
echo strlen($description) > 150 ? substr($description, 0, 150) . '...' : $description;
?><br><br>

<a href="<?php echo $otherPost['Video']['video_link']; ?>" target="_blank" class="link"><i class="fa fa-video-camera"></i> Watch Now</a>
...
<div class="mainheading text-center"><h2>Meet Our Scholars</h2></div>
</div>	
<div class="wow slideInUp" style="visibility: visible; animation-name: slideInUp;">
...
<div class="guideimg">
	<?php echo $this->bs->image('OurTeam.image_file',$ourTeam,['alt'=>'soil-2-soul-our-team'.$ourTeam['OurTeam']['name'],'title'=>$ourTeam['OurTeam']['name']]); ?>
</div>
<h5><?php echo $ourTeam['OurTeam']['name'];?></h5>	
<h6 style="color: #000"><?php echo $ourTeam['OurTeam']['expertise'];?></h6>	
</div>		
</div>	
</a>
<?php } ?>
...
<div class="text-center"><img src="<?php echo $this->webroot;?>img/elephant_left.png"  alt="soil-2-soul-elephant"/> &nbsp; <a href="<?php echo Router::url('/our-scholars'); ?>"><button type="button" class="viewallbtn">Our Scholars</button></a> &nbsp; <img src="<?php echo $this->webroot;?>img/elephant_right.png"  alt="soil-2-soul-elephant"/> </div>
</div>	
</div>	
</section>	
<?php } ?>
...
<div class="wow slideInUp" style="visibility: visible; animation-name: slideInUp;">	
<div class=""><img src="<?php echo $this->webroot;?>img/logoshape_heading.png" class="img-responsive center-block" alt="soil-2-soul-lotus-logo" title="Soil 2 Soul : expeditions"></div>	
...
<div class="whychoosebox <?php echo $bookingFacility['BookingFacility']['class'];?>">
...
<img src="<?php echo $this->webroot;?>img/swastika.png" alt="soil-2-soul-swastika"/> </div>	
</div>
</div>		
</div>	
<?php } ?>
...
<!--Blogs section start here-->
<div class="wow slideInUp" style="visibility: visible; animation-name: slideInUp;">	
<div class="topmargin60"><img src="<?php echo $this->webroot ?>img/logoshape_heading.png" class="img-responsive center-block" alt="soil-2-soul-lotus-logo" title="Soil 2 Soul : expeditions"></div>	

<?php 
	...
	echo $this->Html->tag('li', $this->Html->link(__('Admin Add Tour Cost Type'), array('controller'=>'tour_cost_types', 'action'=>'admin_add'), array()), array('class'=>'active', 'typeof'=>'v:Breadcrumb') );
	echo $this->end();
?>
...
<div class="portlet box yellow">
	<div class="portlet-title">
		<div class="caption">
            <?php echo __('Add Tour Cost Type'); ?> <?php echo $this->Bs->loader(); ?>        
        </div>

<?php 
	...
	echo $this->Html->tag('li', $this->Html->link(__('Admin Edit Faq'), array('controller'=>'faqs', 'action'=>'admin_edit', $this->Form->value('Faq.id')), array()), array('class'=>'active', 'typeof'=>'v:Breadcrumb') );
	echo $this->end();
?>
...
<div class="portlet box yellow">
	<div class="portlet-title">
		<div class="caption">
            <?php echo __('Admin General FAQs'); ?> <?php echo $this->Bs->loader(); ?>        </div>
		...
		<?php
			...
			$dropdownMenuLink[] = $this->Bs->link(__('View'), array('action'=>'view', $this->Form->value('Faq.id')), array('icon'=>'search', 'class'=>'btn btn-sm white btn-outline', 'data-toggle'=>'modal-manager'));
			if($isLoggedIn && $userRole['delete']) : 
				$dropdownMenuLink[] = $this->Bs->link(__('Delete'), array('action'=>'delete', $this->Form->value('Faq.id')), array('icon'=>'trash-o', 'class'=>'btn white btn-sm btn-outline', 'data-toggle'=>'modal-manager'));
			endif;
	...
	<div class="portlet-body form">
		<?php echo $this->Bs->create('Faq', array('class'=>'form-vertical','type'=>'file'));?>
        <div class="form-body">
		<?php
			...
			echo $this->html->div('tab-box',
				$this->html->div('row',
				$this->Bs->input('faq_type_id', ['empty' => 'Select','class' => 'addNewFaqTypeId','col' => 6,'options' => $generalFaq]).
			...
			echo $this->html->div('tab-box',
				$this->html->div('row',
				    $this->Bs->input('question', array('type'=>'text','col'=>'6','rows'=>'2')).
				    $this->Bs->input('answer',array('type'=>'text','col'=>'6','rows'=>'2'))
				)
			);

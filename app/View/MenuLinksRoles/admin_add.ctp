<?php 
	...
	echo $this->Html->tag('li', $this->Html->link(__('Admin Add Menu Links Role'), array('controller'=>'menu_links_roles', 'action'=>'admin_add'), array()), array('class'=>'active', 'typeof'=>'v:Breadcrumb') );
	echo $this->end();
?>
...
<div class="portlet box blue-hoki">
	<div class="portlet-title">
		<div class="caption">
            <?php echo __('Admin Add Menu Links Role'); ?> <?php echo $this->Bs->loader(); ?>
        </div>
        ...
        <div class="tools">
            ...
            <a href="" class="reload" data-original-title="" title="" data-url="<?=$this->Html->url(array('controller'=>'menu_links_roles', 'action'=>'admin_add'))?>"> </a>
        </div>
	</div>

<?php 
	...
	echo $this->Html->tag('li', $this->Html->link(__('Admin Edit Tour Glimpse'), array()), array('class'=>'active', 'typeof'=>'v:Breadcrumb') );
	echo $this->end();
?>
...
<div class="portlet box yellow">
	<div class="portlet-title">
		<div class="caption">
            <?php echo __('Admin Edit Tour Glimpse'); ?> <?php echo $this->Bs->loader(); ?>        </div>
		...
		<?php
			...
			$dropdownMenuLink[] = $this->Bs->link(__('View'), array('action'=>'view', $this->Form->value('TourGlimpse.id')), array('icon'=>'search', 'class'=>'btn btn-sm white btn-outline', 'data-toggle'=>'modal-manager'));
			if($isLoggedIn && $userRole['delete']) : 
				$dropdownMenuLink[] = $this->Bs->link(__('Delete'), array('action'=>'delete', $this->Form->value('TourGlimpse.id')), array('icon'=>'trash-o', 'class'=>'btn white btn-sm btn-outline', 'data-toggle'=>'modal-manager'));
			endif;
	...
	<div class="portlet-body form">
		...
		<?php
			...
			echo $this->html->div('tab-box',
				$this->html->div('row',
					 $this->Bs->input('our_journy_id', array('empty'=>'Select', 'class'=>'addNewOurJournyId','col'=>'4','label'=>'Our Journey')).

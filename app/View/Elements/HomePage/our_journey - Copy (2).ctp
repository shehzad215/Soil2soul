...
<<<<<<< .mine
	<div class="topmargin70">
		<img src="img/logoshape_heading.png" class="img-responsive center-block" alt="soil-2-soul-logo">
	</div>	
	<div class="mainheading text-center"><h2>Our Journeys</h2></div>	
</div>
||||||| .r143
<div class="topmargin70"><img src="<?php echo $this->webroot;?>img/logoshape_heading.png" class="img-responsive center-block"></div>	
<div class="mainheading text-center"><h2>Our Journeys</h2></div>	
</div>	
=======
		...
		<ul class="tabs5">
         ...
         <div class="tab_container5">
			...
			$shortNote = substr($shortNote, 0,130);
	       	...
	       	$htmlUrl = $this->Html->url(array('controller'=>'packages','action'=>'index','id' => $package['Package']['id'],'package_slug'=>$package['Package']['page_slug']));
	       ...
	       ?>
            ...
            <h3><a href="selected_journeys.html"><?php echo $package['Package']['name'];?></a></h3>
            ...
            <?php 
            	...
            	$sr++;	
            ?>
            	<li><span>Trail <?php echo sprintf("%02d", $sr);;?>:</span> <?php echo $value['name']; ?> <div class="traillink"><a href="journeysdetails.html"><i class="fa fa-chevron-circle-right"></i></a></div></li>
            <?php } ?>	
...
<div class="text-center"><img src="img/elephant_left.png"  alt="soil-2-soul-elephant-logo"/> &nbsp; <a href="<?php echo Router::url('/our_journies'); ?>"><button type="button" class="viewallbtn">View all Journeys</button></a> &nbsp; <img src="img/elephant_right.png"  alt="soil-2-soul-elephant-logo"/> </div>
</div>	
<<<<<<< .mine
</div>		||||||| .r143
</div>	
...
<div class="text-center"><img src="<?php echo $this->webroot;?>img/elephant_left.png"  alt=""/> &nbsp; <a href="<?php echo Router::url('/our_journies'); ?>"><button type="button" class="viewallbtn">View all Journeys</button></a> &nbsp; <img src="<?php echo $this->webroot;?>img/elephant_right.png"  alt=""/> </div>
</div>	
</div>=======
</div>	
<?php  } ?>	
...
<div class="wow zoomIn" style="visibility: visible; animation-name: zoomIn;">		
<div class="text-center"><img src="<?php echo $this->webroot;?>img/elephant_left.png"  alt="soil-2-soul-elephant"/> &nbsp; <a href="<?php echo Router::url('/our_journies'); ?>"><button type="button" class="viewallbtn">View all Journeys</button></a> &nbsp; <img src="<?php echo $this->webroot;?>img/elephant_right.png"  alt="soil-2-soul-elephant"/> </div>
</div>	
</div>>>>>>>> .r146

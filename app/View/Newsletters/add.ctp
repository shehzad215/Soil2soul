<?php 
	...
	echo $this->Html->tag('li', $this->Html->link(__('Add Newsletter'), array('controller'=>'newsletters', 'action'=>'add'), array()), array('class'=>'active', 'typeof'=>'v:Breadcrumb') );
	echo $this->end();
?>
...
<div class="portlet box green">
	<div class="portlet-title">
		<div class="caption">
            <?php echo __('Add Newsletter'); ?> <?php echo $this->Bs->loader(); ?>        </div>

<?php 
	...
	echo $this->Html->tag('li', $this->Html->link(__('Admin Add Newsletter'), array('controller'=>'newsletters', 'action'=>'admin_add'), array()), array('class'=>'active', 'typeof'=>'v:Breadcrumb') );
	echo $this->end();
?>
...
<div class="portlet box green">
	<div class="portlet-title">
		<div class="caption">
            <?php echo __('Admin Add Newsletter'); ?> <?php echo $this->Bs->loader(); ?>        </div>

...
<img src="<?php echo $this->webroot; ?>img/thumbnail_scholars_collage.jpg" alt="soil-2-soul-our-teams" title="Soil 2 Soul : Our Teams"> </section>
<!--Collage end here-->
  ...
  <div class="teamlist">
    <ul>
     <?php foreach ($ourTeams as $key => $ourTeam) {
          ...
          $shortNote = substr($ourTeam['OurTeam']['description'], 0, 60).'...';
      ...
      <li>
        <div class="scholarboxcont"> <a href="<?php echo $this->html->url(['controller'=>'our_teams','action'=>'view','team_slug'=>$slug]); ?>">
          <div class="scholarbox">
            ...
            <div class="text-center topmargin5"><?php echo (!empty($ourTeam['OurTeam']['expertise'])) ? $ourTeam['OurTeam']['expertise'] : '';?></div>

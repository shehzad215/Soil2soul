...
<?php 
	...
	echo $this->Html->tag('li', $this->Html->link(__('Our Journey Exclusions'), array('controller'=>'our_journey_exlusions', 'action'=>'index'), array('rel'=>'v:url', 'property'=>'v:title')), array('typeof'=>'v:Breadcrumb') );
...
<div class="col-md-12">
    <div class='portlet box yellow'>
        <div class="portlet-title">
            <div class="caption"><?php echo __('Our Journey Exclusions'); ?> <?php echo $this->Bs->loader(); ?></div>
            <div class="actions">
    		<?php
        ...
        <div class="portlet-body">
            ...
            <div class="table-responsive">
				...
				<tr class='<?php echo 'tr_'.$ourJourneyExlusion['OurJourneyExlusion']['id']; ?>'>
					...
					<td class='text-center'><input data-set-row="countries-checkbox"  type="checkbox" name="check[]" value="<?php echo h($ourJourneyExlusion['OurJourneyExlusion']['active']); ?>" class ='activeClass'  data-value="<?php echo $ourJourneyExlusion['OurJourneyExlusion']['id'];?>" <?php  if($ourJourneyExlusion['OurJourneyExlusion']['active'] == 1){ ?> checked <?php }?>>&nbsp;</td>
...
/*Active Fucntionality*/
	$('.activeClass').change(function(){
		...
		var exclusionid = $(this).attr('data-value');
		 $.ajax({
          type:"POST",
          url: "<?php echo $this->Html->url(['controller'=>'our_journey_exlusions','action'=>'is_active']); ?>",
          data: {"exclusionid":exclusionid,"checkedid":checkedid} 
        });
	});

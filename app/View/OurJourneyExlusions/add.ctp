<?php 
	...
	echo $this->Html->tag('li', $this->Html->link(__('Add Our Journey Exlusion'), array('controller'=>'our_journey_exlusions', 'action'=>'add'), array()), array('class'=>'active', 'typeof'=>'v:Breadcrumb') );
	echo $this->end();
?>
...
<div class="portlet box yellow">
	<div class="portlet-title">
		<div class="caption">
            <?php echo __('Add Our Journey Exlusion'); ?> <?php echo $this->Bs->loader(); ?>        </div>

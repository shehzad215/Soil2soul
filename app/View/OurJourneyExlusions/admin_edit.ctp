<?php 
	...
	echo $this->Html->tag('li', $this->Html->link(__('Admin Edit Our Journey Exlusion'), array('controller'=>'our_journey_exlusions', 'action'=>'admin_edit', $this->Form->value('OurJourneyExlusion.id')), array()), array('class'=>'active', 'typeof'=>'v:Breadcrumb') );
	echo $this->end();
?>
...
<div class="portlet box yellow">
	<div class="portlet-title">
		<div class="caption">
            <?php echo __('Admin Edit Our Journey Exlusion'); ?> <?php echo $this->Bs->loader(); ?>        </div>

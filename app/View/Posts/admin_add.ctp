<?php 
	...
	echo $this->Html->tag('li', $this->Html->link(__('Admin Add Blog'), array('controller'=>'posts', 'action'=>'admin_add'), array()), array('class'=>'active', 'typeof'=>'v:Breadcrumb') );
	echo $this->end();
?>
...
<div class="portlet box blue-hoki">
	<div class="portlet-title">
		...
		<?php
			...
			//$dropdownMenu = array(
				//$this->Bs->menuLink(__('Posts'), array('controller'=>'posts', 'action'=>'index'), array('icon'=>'list', 'data-toggle'=>'modal-manager')),
			...
			//$dropdownMenuLink[] = $this->Bs->link(__('Posts'), array('action' => 'index'), array('icon'=>'list', 'class'=>'btn default btn-sm', 'data-toggle'=>'modal-manager'));
        ...
        <div class="tools">
            ...
            <a href="" class="reload" data-original-title="" title="" data-url="<?=$this->Html->url(array('controller'=>'posts', 'action'=>'admin_add'))?>"> </a> -->
        </div>
	</div>
	<div class="portlet-body form">
        ...
        <div class="form-body">
		<?php
			//echo $this->Bs->input('parent_id', array('empty'=>'Select', 'class'=>'addNewParentId', 'append'=>array('button'=>'Add New')));
			//echo $this->Bs->input('parent_id', array( 'empty'=>'Root', 'options'=>$parentPosts,'class'=>'addNewParentId', 'append'=>array('button'=>'Add New')));

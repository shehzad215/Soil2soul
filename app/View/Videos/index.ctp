...
<br></div>
<?php //debug($videocategories);die; ?>
<?php if(!empty($videocategories)){ ?>
<div class="mainheading text-center"><h3>Explore videos by Categories</h3></div>
<div class="bx-wrapper4">
<div class="bxslider6">

<?php //debug($videocategories);die; ?>

<?php foreach ($videocategories as $key => $videocategory) { ?>
<div class="blogcatbox">  
<a href="<?php echo $this->Html->url(array('controller'=>'video_categories','action'=>'index','video_cat_slug' => $videocategory['VideoCategory']['page_slug']))?>">  
<div class="blogcatboximg">
<div class="blogcatboxshade"><h6><?php echo $videocategory['VideoCategory']['name']; ?></h6></div>
<?php echo $this->Bs->image('VideoCategory.image_file',$videocategory,['alt'=>$videocategory['VideoCategory']['name']]) ?>  
<!-- <img src="<?php //echo $this->webroot;?>img/blogcat_img01.jpg" alt=""> -->
</div>
</a>  
</div>
<?php } ?>
...
<div class="row">
<div class="col-sm-9">
<div class="mainheading"><h3>Latest Videos</h3></div> 
...
<?php echo strlen($video['Video']['description']) > 450 ? substr($video['Video']['description'], 0, 450) . '... <a href="#" class="prevent OurVideoModel" data_id="' . $video['Video']['id'] . '">Read More</a>' : $video['Video']['description']; ?>
</div>    
</div>
...
<div class="container">               
  <iframe src="" title="YouTube video player" frameborder="0" style="aspect-ratio: 14 / 7;
  width: 100%;" ></iframe>
</div>
</div>
</div>
...
<div class="mainheading"><h3>Search for Videos</h3></div> 
...
<span id="nerror2" style="color:red"></span>
...
<li><a href="<?php echo $this->Html->url(array('controller'=>'blog_tags','action'=>'video_tags','video_tag_slug' => $blogTag['BlogTag']['page_slug']))?>"><?php echo $blogTag['BlogTag']['name']; ?></a></li>
<?php } ?>
</ul> 
</div>  
</div>
...
type:"POST",
dataType : 'html',
url: "<?php echo $this->Html->url(['controller'=>'videos','action'=>'search_video']); ?>",
...
$('#nerror2').text('Please Add Text For Search');
}

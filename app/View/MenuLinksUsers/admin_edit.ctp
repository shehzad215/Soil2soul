<?php 
	...
	echo $this->Html->tag('li', $this->Html->link(__('Admin Edit Menu Links User'), array('controller'=>'menu_links_users', 'action'=>'admin_edit', $this->Form->value('MenuLinksUser.id')), array()), array('class'=>'active', 'typeof'=>'v:Breadcrumb') );
	echo $this->end();
?>
...
<div class="portlet box blue-hoki">
	<div class="portlet-title">
		<div class="caption">
            <?php echo __('Admin Edit Menu Links User'); ?> <?php echo $this->Bs->loader(); ?>        </div>
		...
		<?php
			...
			$dropdownMenuLink[] = $this->Bs->link(__('View'), array('action'=>'view', $this->Form->value('MenuLinksUser.id')), array('icon'=>'search', 'class'=>'btn default btn-sm', 'data-toggle'=>'modal-manager'));
			if($isLoggedIn && $userRole['delete']) : 
				$dropdownMenuLink[] = $this->Bs->link(__('Delete'), array('action'=>'delete', $this->Form->value('MenuLinksUser.id')), array('icon'=>'trash-o', 'class'=>'btn default btn-sm', 'data-toggle'=>'modal-manager'));
			endif;
        ...
        <div class="tools">
            ...
            <a href="" class="reload" data-original-title="" title="" data-url="<?=$this->Html->url(array('controller'=>'menu_links_users', 'action'=>'admin_edit', $this->Form->value('MenuLinksUser.id')))?>"> </a>
        </div>
	</div>

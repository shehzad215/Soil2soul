...
<div class="row">
  <?php echo $this->Form->create('ContactEnquery', array('class'=>'form-vertical','type'=>'file'));
...
<div class="form-group">
   <?php //echo $this->Bs->input('first_name',['type'=>'text','placeholder'=>'First Name','class'=>'form-control']);
        echo $this->Form->input('first_name',['type'=>'text','placeholder'=>'First Name','class'=>'form-control']);
   ?>
</div>    
</div>
<div class="col-sm-6">
<div class="form-group">
  <?php echo $this->Form->input('last_name',['type'=>'text','placeholder'=>'Last Name','class'=>'form-control']); ?>
</div>    
</div>
<div class="col-sm-6">
<div class="form-group">
...
<div class="col-xs-9 padding5px">
    <?php 
    echo $this->Form->input('contact_no',['type'=>'text','placeholder'=>'Mobile','class'=>'form-control numeric','maxlength'=>10]);
  ?>
</div>    
</div>    
</div>    
...
<div class="col-sm-6">
<div class="form-group">
  <?php echo $this->Form->input('email',['type'=>'email','placeholder'=>'Email','class'=>'form-control']); ?>
</div>    
</div>
<div class="col-sm-12">
<div class="form-group">
    <?php echo $this->Form->input('msg',['type'=>'text','placeholder'=>'Message','rows'=>'5']);?>
</div>    
</div>  
</div>    
<div>
